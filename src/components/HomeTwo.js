...
const HomeTwo = () => {
    ...
    return (
        <div name="homeTwo" className='text-white border-l-2 border-[#c31432]  w-full h-screen'>
            <div className='flex flex-col justify-start sm:justify-center h-full ml-6 sm:mx-8' >
