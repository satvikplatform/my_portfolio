...
const Work = () => {
  return (
    <div name="work" className="text-white h-[900px] sm:h-screen border-orange-500 border-l-2">
      <div className="px-4 sm:mx-6">
        <h1 className="text-3xl  md:text-4xl border-b-4 inline-block border-b-[#eb1c3e]  font-bold">Work:</h1>
