...
const Work = () => {
  return (
    <div name="work" className="text-white h-[900px] sm:h-screen  border-[#c31432] border-l-2 2xl:flex items-center justify-center   ">
      <div>
        ...
        <div className='flex overflow-auto flex-wrap justify-center animation-three'>
          <div className='w-full z-[-10] xl:z-40 relative rounded-lg group opacity-80 hover:opacity-100 hover:scale-110  m-2    flex justify-center items-center  font-bold  sm:w-1/3 md:w-1/4 xl:w-1/4 2xl:w-1/3 h-[180px] sm:h-[200px] xl:h-[230px]'>
